***
Please be aware that the CRAM file line has been omitted in the input.txt as it requires the -C <reference_path> flag when running deepmosaic-draw. The CRAM file was created using hg19, so please use your own downloaded hg19 reference file to test the demo.
