...
#all_repeats_path = pkg_resources.resource_filename('deepmosaic', 'resources/all_repeats.hg38.bed')
#segdup_path = pkg_resources.resource_filename('deepmosaic', 'resources/segdup.hg19.bed')
HERE = os.path.abspath(os.path.dirname(__file__))
all_repeats_path = os.path.join(HERE, "./resources/all_repeats.hg38.bed")
segdup_path = os.path.join(HERE, "./resources/segdup.hg38.bed")
