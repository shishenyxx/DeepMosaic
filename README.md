...
# Cite DeepMosaic
Yang X, Xin X, et al. Gleeson JG. DeepMosaic: Control-independent mosaic single nucleotide variant detection using deep convolutional neural networks. (2020 [bioRxiv](https://www.biorxiv.org/content/10.1101/2020.11.14.382473v1))
