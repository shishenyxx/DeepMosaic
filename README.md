...
6. `[path to ANNOVAR]` is the absolute path to the ANNOVAR program directory.
...
Singularity containers can be found on [dockerhub](https://hub.docker.com/r/arzoopatel5/deepmosaic).
