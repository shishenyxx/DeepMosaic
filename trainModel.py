...
def getOptions(args=sys.argv[1:]):
    ...
    parser.add_argument("-e", "--train_epoch", required=False, type=int, default=0, help="conduct training on user-provided labeled provided number of epochs to train.")
    parser.add_argument("-m", "--model", required=False, default="efficientnet-b0", help="the convolutional neural network model transfer learning is based on.")
...
def main():
    ...
    train_epoch = int(opions.train_epoch)
